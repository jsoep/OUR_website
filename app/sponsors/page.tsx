        ...
        <div className="space-y-20 mb-20">
          {sponsors.length > 0 ? (
            sponsors.map((sponsor, index) => {
              ...
              return (
                <div key={sponsor.slug} className="border-b border-gray-200 pb-16 last:border-0 last:pb-0">
                  <div className={`flex flex-col lg:flex-row items-start lg:items-center gap-12 ${isEven ? '' : 'lg:flex-row-reverse'}`}>
                    {/* Logo */}
                    <div className="flex-shrink-0">
                      {sponsor.website ? (
                        <a
                          ...
                          className="block"
                        >
                          <div className="relative w-64 h-32 bg-white rounded-lg shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                            <Image
                              src={sponsor.logo}
                        ...
                        <div className="relative w-64 h-32 bg-white rounded-lg shadow-sm border border-gray-100 p-6">
                          <Image
                            src={sponsor.logo}
                            alt={`${sponsor.name} logo`}
                            fill
                    ...
                    <div className="flex-1">
                      <h3 className="text-3xl font-bold text-oxford-blue mb-6">{sponsor.name}</h3>
                      ...
                      {sponsor.website && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center text-oxford-blue hover:text-accent-red font-medium text-lg transition-colors"
                        >
                          Visit Website
